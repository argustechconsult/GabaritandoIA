...
const MindMap: React.FC<MindMapProps> = ({ data }) => {
  ...
  useEffect(() => {
    ...
    // Collapse after the second level initially to encourage "advancing"
    if (root.children) {
  ...
  if (!data) return <div className="text-gray-500 text-center py-10">Nenhum mapa mental gerado.</div>;

  return (
    <div ref={wrapperRef} className="w-full h-[600px] bg-gray-50 rounded-xl shadow-inner border border-gray-200 relative overflow-hidden">
