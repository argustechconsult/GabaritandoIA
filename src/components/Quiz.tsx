    ...
    return (
      <div className="flex flex-col items-center justify-center p-8 bg-white rounded-xl shadow-lg max-w-2xl mx-auto mt-10">
        ...
        <p className="text-xl text-gray-600 mb-8">
          Você acertou{' '}
          <span className="font-bold text-indigo-600">{score}</span> de{' '}
    ...
    <div className="w-full max-w-3xl mx-auto p-4 md:p-6">
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
        ...
        <div className="bg-indigo-50 px-6 py-4 flex justify-between items-center border-b border-indigo-100">
          <span className="text-indigo-800 font-bold uppercase tracking-wider text-sm">
          ...
          <div className="space-y-3">
            {question.options.map((option, idx) => {
              ...
              if (selectedOption !== null) {
                if (idx === correctIndex) {
                  buttonStyle =
                    'bg-green-100 border-green-500 text-green-800 font-medium'; // Correct
              ...
              return (
                ...
                >
                  <div
                    className={`flex-shrink-0 w-8 h-8 rounded-full border-2 flex items-center justify-center mr-4 font-bold text-sm
                    ${
