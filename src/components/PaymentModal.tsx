      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden transform transition-all">
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 p-6 text-center">
          <h2 className="text-2xl font-bold text-white mb-2">
            Desbloqueie o Ilimitado
          </h2>
          <p className="text-indigo-100">
            Torne-se um mestre nos estudos agora!
          </p>
        </div>
        ...
        <div className="p-8">
          ...
          <p className="text-gray-600 text-center mb-6">
            Você atingiu o limite do plano gratuito (1 PDF). Para gerar
            materiais de estudo ilimitados, assine o plano Premium.
          </p>
          ...
          <div className="space-y-3">
            <button
              ...
              disabled={isLoading}
              className={`w-full py-3 px-4 bg-[#2C3E2C] hover:bg-[#3A523A] text-white font-semibold rounded-lg shadow transition-colors duration-200 flex items-center justify-center ${
