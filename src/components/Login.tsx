        ...
        <div className="flex flex-col space-y-4 order-1 md:order-2">
          <div className="bg-white p-6 rounded-xl shadow-md border-l-4 border-indigo-500">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Clique em um cartão abaixo para preencher automaticamente.
            </p>
          ...
          <div className="bg-blue-50 p-4 rounded-xl border border-blue-100 text-sm text-blue-800">
            <p>
              💡 <strong>Dica:</strong> O usuário <b>Free</b> será bloqueado ao
              tentar enviar o segundo PDF, ativando o fluxo de pagamento do
              AbacatePay.
            </p>
          </div>
        </div>
